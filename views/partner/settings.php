        ...
        <div style="grid-column: 1 / -1; margin-top: 30px; padding-top: 20px; border-top: 1px solid var(--glass-border);">
            ...
            <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 25px;">
                <div class="form-group">
                    ...
                    <small style="color:var(--text-secondary); margin-top:5px; display:block; font-size:11px;">Gunakan placeholder: {nama}, {id_cust}, {paket}, {bulan}, {tagihan}, {jatuh_tempo}, {rekening}, {tunggakan}, {total_harus}, {link_tagihan}</small>
                </div>
                <div class="form-group">
                    ...
                    <small style="color:var(--text-secondary); margin-top:5px; display:block; font-size:11px;">Gunakan placeholder: {nama}, {id_cust}, {paket}, {bulan}, {tagihan}, {tunggakan}, {waktu_bayar}, {admin}, {link_tagihan}</small>
                </div>
            </div>
